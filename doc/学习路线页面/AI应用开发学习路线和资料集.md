...
本人自学AI应用开发，找资料和学习的过程中浪费了很多不必要的时间，为了让朋友们尽可能少走弯路，特意整理这份资料。
...
![image-20260512203525606](AI应用开发学习路线和资料集.assets/image-20260512203525606.png)
...
![向量数据库分类图](https://datawhalechina.github.io/all-in-rag/chapter3/images/3_3_1.webp)
